...
public class Main {
    public static void main(String[] args) {
        ...
        Part part = new Part("Widget", "P123", 101);
        Product product = new Product("Gadget", "PR456", assemblyStation, new ArrayList<>());

        // Create a task for the assembly station
        Task task = new Task(ActionType.ASSEMBLE_ITEM, AssetType.ASSEMBLY_STATION, product);
        task.setPart(part);  // Assign the part to the task as well
